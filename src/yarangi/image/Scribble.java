...
*/
public void clearPanel(final Panel p)
{
...
/*
 ...
 Note: In initial attempt the previous mouse coordinates
       ...
       arbitrary point.
*/
public void penOperation(final MouseEvent e)
{
...
/*
 ...
 dragmode.
*/
public void lineOperation(final MouseEvent e)
{
  Graphics g  = drawPanel.getGraphics();
  g.setColor(mainColor);
...
/*
 ...
 dragmode.
*/
public void rectOperation(final MouseEvent e)
{
  Graphics g  = drawPanel.getGraphics();
  g.setColor(mainColor);
...
/*
 ...
 dragmode.
*/
public void ovalOperation(final MouseEvent e)
{
  Graphics g  = drawPanel.getGraphics();
  g.setColor(mainColor);
...
/*
 ...
 dragmode.
*/
public void frectOperation(final MouseEvent e)
{
...
/*
 ...
 dragmode.
*/
public void fovalOperation(final MouseEvent e)
{
  Graphics g  = drawPanel.getGraphics();
  g.setColor(mainColor);
...
*/
public void eraserOperation(final MouseEvent e)
{
  Graphics g  = drawPanel.getGraphics();
...
*/
public void polygonOperation(final MouseEvent e)
{
  if (initialPolygon)
  {
     prevx = e.getX();
...
*/
public void splineOperation(final MouseEvent e)
{
 if(initialSpline)
 {
    initialSpline = false;
...
*/
public boolean mouseHasMoved(final MouseEvent e)
{
...
*/
public void setGraphicalDefaults(final MouseEvent e)
{
  mousex   = e.getX();
  mousey   = e.getY();
  prevx    = e.getX();
...
*/
public void updateMouseCoordinates(final MouseEvent e)
{
  String xCoor ="";
  String yCoor ="";
